...
<div class="page-heading">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="text-muted mb-0">Perbarui aturan rule-based.</p>
        </div>
...
<div class="card">
<div class="card-header"><h4 class="card-title">Form Edit Rule</h4></div>
<div class="card-body">
<form action="{{ route('recommendation-rules.update', $recommendationRule->id) }}" method="POST">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" name="rule_name" class="form-control" value="{{ old('rule_name', $recommendationRule->rule_name) }}">
        </div>
        ...
        <div class="col-md-4 mb-3">
            ...
            <select name="butuh_rias" class="form-select">
                ...
                <option value="1" {{ old('butuh_rias', $recommendationRule->butuh_rias) === 1 ? 'selected' : '' }}>Ya</option>
                <option value="0" {{ old('butuh_rias', $recommendationRule->butuh_rias) === 0 ? 'selected' : '' }}>Tidak</option>
            </select>
        </div>
        <div class="col-md-4 mb-3">
            <label class="form-label">Size (Opsional)</label>
            <input type="text" name="size" class="form-control" value="{{ old('size', $recommendationRule->size) }}">
        </div>
